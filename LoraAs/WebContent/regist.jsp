...
<html>
  <head>
  	<script type="text/javascript">
  		...
  		/* function Nullcheck(name,msg){
  			document.getElementById(name+"_msg").innerHTML+"";//首先在后面不加入任何文字
  			var objValue=document.getElementsByName(name)[0].value; //得到value的值
  ...
  <div align="center" >
  	<h1>Estore注册</h1><hr>
  	<form action="/Estore/RegistServlet" method="POST" onsubmit="return checkForm()">
  		<table>
  			<tr>
  				<td>用户名:</td>
  			...
  			<tr>
  				...
  				<td><img src="/Estore/ValiImg" onclick="changeImg(this)" style="cursor: pointer;"/></td>
  			</tr>
